...
# Load includes in current shell
# ------------------------------------------------------------------------------
for file in ${DOTBRAGA}/includes/*; do [[ -f $file ]] && source $file; done
...
# TODO: Create PYTHON_VERSION variable and refactor these two definitions
# [[ -e "/home/thiago/lib/oracle-cli/lib/python3.11/site-packages/oci_cli/bin/oci_autocomplete.sh" ]] && source "/home/thiago/lib/oracle-cli/lib/python3.11/site-packages/oci_cli/bin/oci_autocomplete.sh"

# Java SDK
# ------------------------------------------------------------------------------
# TODO: Enable this block by toggle
...
#export PATH=/home/thiago/bin:$PATH
